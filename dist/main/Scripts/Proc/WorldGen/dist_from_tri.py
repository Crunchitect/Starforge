...
def point_triangle_distance_Vec3(TRI: tuple[Vec3, Vec3, Vec3], P: Vec3):
    triangle = numpy.array([[TRI[0].x, TRI[0].y, TRI[0].z],
                            [TRI[1].x, TRI[1].y, TRI[1].z],
                            [TRI[2].x, TRI[2].y, TRI[2].z]])
    point = numpy.array([P.x, P.y, P.z])
    return pointTriangleDistance(triangle, point)
